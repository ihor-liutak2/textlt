...
private:
    ...
    void ActivateOpenDocumentSession(size_t index);
    void AddOpenDocumentSession(std::shared_ptr<DocumentSession> doc);
    void EnsureOneOpenDocumentSession();
    void RemoveOpenDocumentSession(size_t index);
